...
"%OSCAR64_DIR%\bin\oscar64.exe" -o="%OUTPUT%" -Os -Oo -Oi -Op -Oz -dDEBUG_MAPGEN -tf=prg -tm=c64 -dNOLONG -dNOFLOAT -psci -i="%OSCAR64_DIR%\include" -i="%OSCAR64_DIR%\include\c64" -i="%SCRIPT_DIR%main\src\mapgen" "%SCRIPT_DIR%main\src\main.c"
