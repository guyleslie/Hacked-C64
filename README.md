...
- **Secret Rooms**: Hidden areas accessible through secret passages (50% of single-connection rooms)
...
3. **Creating Secret Areas**: Single-connection rooms become hidden passages (50% chance)
